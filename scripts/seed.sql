...
(4,'PEM-VAL-005','系统验证·诊断包装机','PKG-260','双工位','包装','BU2-B02','running','2026-09-04 00:43:56','2026-09-04 00:43:56','系统验证供应商·给药装配',260,0.8700,'封装材料切换与停机待料',7.200,1,42.50,6,0.0200,0,'系统管理员 Excel 导入验证数据；上线生产前请替换为现场实际台账。',2,2,4,'包装设备','B','陈工','2023-10-17 08:00:00','2026-10-16 08:00:00',NULL),
(5,'PEM-VAL-006','系统验证·生化分析装配台','BCA-90','90工位','分析仪装配','BU3-C01','running','2026-09-04 00:43:56','2026-09-04 00:43:56','系统验证供应商·诊断装备',90,0.9200,NULL,3.100,4,18.60,5,0.0100,1,'系统管理员 Excel 导入验证数据；上线生产前请替换为现场实际台账。',3,3,3,'精密装配设备','B','赵工','2024-04-07 08:00:00','2027-04-06 08:00:00',NULL),
(6,'PEM-VAL-007','系统验证·诊断卡封装机','CAR-400','400卡/小时','卡片封装','BU3-C02','running','2026-09-04 00:43:56','2026-09-04 00:43:56','系统验证供应商·给药装配',400,0.8900,'设备调试与物料补给间隔',6.400,1,49.80,7,0.0200,1,'系统管理员 Excel 导入验证数据；上线生产前请替换为现场实际台账。',3,3,4,'封装设备','A','赵工','2024-05-15 08:00:00','2027-05-14 08:00:00',NULL),
(7,'PEM-VAL-008','系统验证·输液器组装线','INF-500','五模块','输液器装配','BU4-D01','running','2026-09-04 00:43:56','2026-09-04 00:43:56','系统验证供应商·给药装配',500,0.9300,NULL,14.200,2,96.00,8,0.0200,1,'系统管理员 Excel 导入验证数据；上线生产前请替换为现场实际台账。',1,1,4,'自动装配设备','A','孙工','2023-11-09 08:00:00','2026-11-08 08:00:00',NULL),
(8,'PEM-VAL-001','系统验证·预灌封注塑机','IM-220','220T','注塑成型','BU1-A01','running','2026-09-04 00:43:56','2026-09-04 00:43:56','系统验证供应商·注塑与输送',480,0.9100,NULL,18.500,2,86.50,8,0.0200,1,'系统管理员 Excel 导入验证数据；上线生产前请替换为现场实际台账。',4,4,2,'注塑成型设备','A','王工','2024-01-14 08:00:00','2027-01-13 08:00:00',NULL),
