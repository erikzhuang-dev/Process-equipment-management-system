...
import { IdentitySwitcher, NotificationBell } from "@/components/ApplySidebarExtras";
import { useIsMobile } from "@/hooks/useMobile";
import { getSidebarPresentation, SIDEBAR_DEFAULT_OPEN } from "@/lib/sidebarPresentation";
import { ClipboardList, FileSignature, Gauge, Languages, ListChecks, PanelLeft, Settings2, ShieldCheck, Wrench } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Wrench, label: "执行跟踪", labelEn: "Execution Tracking", path: "/apply/execution", match: (loc: string) => loc.startsWith("/apply/execution") || loc.startsWith("/apply/acceptance") },
