...
function App() {
  return <ErrorBoundary><LanguageProvider><ThemeProvider defaultTheme="light"><IdentityProvider><TooltipProvider><Toaster richColors position="top-right" /><Switch><Route path="/" component={Workspace} /><Route path="/dashboard" component={Workspace} /><Route path="/equipment/:id"><DashboardLayout><EquipmentDetail /></DashboardLayout></Route><Route path="/equipment" component={Workspace} /><Route path="/maintenance" component={Workspace} /><Route path="/repairs" component={Workspace} /><Route path="/parts" component={Workspace} /><Route path="/users" component={Workspace} /><Route path="/apply/change/new" component={ChangeApplyNew} /><Route path="/apply/purchase/new" component={PurchaseApplyNew} /><Route path="/apply/mine"><DashboardLayout><MyApplies /></DashboardLayout></Route><Route path="/approvals" component={ApprovalCenter} /><Route path="/apply/execution" component={ExecutionBoard} /><Route path="/apply/acceptance" component={AcceptancePage} /><Route path="/apply/settings" component={ApplySettings} /><Route path="/apply/notifications" component={NotificationsPage} /><Route component={Workspace} /></Switch></TooltipProvider></IdentityProvider></ThemeProvider></LanguageProvider></ErrorBoundary>;
}
