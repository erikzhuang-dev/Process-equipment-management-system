...
const translations: Record<string, string> = {
  ...
  "设备详情": "Equipment Detail", "编辑设备详情": "Edit Equipment Detail", "保存后会刷新台账、详情、仪表盘与导出数据。": "Saving refreshes the register, detail, dashboard, and export data.", "取消": "Cancel", "所属 BU": "Business Unit", "工厂": "Factory", "供应商": "Supplier", "资产类别": "Asset Category", "关键等级": "Criticality", "责任人": "Responsible Owner", "启用日期": "Commissioned Date", "保修到期日": "Warranty Expiry", "每小时产能（pcs）": "Hourly Capacity (pcs)", "OEE（0–1）": "OEE (0–1)", "能耗（kW）": "Energy Consumption (kW)", "数量（台）": "Quantity (units)", "单价（万元）": "Unit Price (10k CNY)", "折旧年数": "Depreciation Years", "损耗系数": "Loss Factor", "合计金额（万元）": "Total Amount (10k CNY)", "计入投资": "Include in Investment", "计入投资：": "Include in Investment:", "计入投资金额（万元）": "Investment Amount (10k CNY)", "OEE偏低原因": "Reason for Low OEE", "OEE 偏低原因": "Reason for Low OEE", "备注": "Notes", "保存详情": "Save detail", "保存中…": "Saving…", "设备详情已保存": "Equipment detail saved", "设备详情保存失败": "Failed to save equipment detail", "正在读取设备详情…": "Loading equipment detail…", "未找到该设备": "Equipment not found", "返回设备台账": "Back to Equipment Register", "返回台账": "Back to Register", "查看详情": "View Detail", "编辑详情": "Edit Detail", "设备编号": "Equipment Code", "设备、生产与生命周期参数": "Equipment, Production & Lifecycle", "投资与折旧": "Investment & Depreciation", "治理信息": "Governance Information", "资产记录更新时间": "Asset record updated", "B 级": "B", "A 级": "A", "C 级": "C", "A · 关键": "A · Critical", "B · 重要": "B · Important", "C · 一般": "C · Standard", "未选择 BU": "No BU selected", "未选择工厂": "No factory selected", "未选择供应商": "No supplier selected", "未分级": "Unclassified", "关键": "Critical", "重要": "Important", "一般": "Standard", "是": "Yes", "否": "No", "未录入": "Not recorded",
};
