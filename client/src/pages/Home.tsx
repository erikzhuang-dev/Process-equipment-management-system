...
type EquipmentForm = {
  ...
  supplier: string; hourlyCapacity: string; oee: string; lowOeeReason: string; energyConsumption: string; quantity: string; unitPrice: string; depreciationYears: string; lossFactor: string; investmentIncluded: boolean; notes: string;
};
...
function EquipmentView({ isAdmin }: { isAdmin: boolean }) {
  ...
  }, [expandedEquipmentId, result.data?.items]);
