...
type EquipmentForm = {
  ...
  supplier: string; businessUnitId: string; factoryId: string; hourlyCapacity: string; oee: string; lowOeeReason: string; energyConsumption: string; quantity: string; unitPrice: string; depreciationYears: string; lossFactor: string; investmentIncluded: boolean; notes: string;
};
...
function InlineEquipmentDetailEditor({ item, businessUnits, factories, isAdmin, onSave }: { item: any; businessUnits: any[]; factories: any[]; isAdmin: boolean; onSave: (values: EquipmentForm) => Promise<unknown> }) {
